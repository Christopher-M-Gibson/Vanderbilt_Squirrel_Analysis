...
no_dups_sd <- squirrel_data[!duplicated(squirrel_data$Unique.Squirrel.ID), ]

# Replace all blanks and ? in Age "Not Recorded"
table(no_dups_sd$Age)
no_dups_sd <- replace(no_dups_sd, no_dups_sd == "", "Not Recorded")
no_dups_sd <- no_dups_sd %>% 
  mutate(Age = recode(Age, "?" = "Not Recorded"))

# =============================================================================
# STEP 2: COMPARING SQUIRREL POPULATIONS BETWEEN VANDERBILT AND CENTRAL PARK
# =============================================================================

# Mapping out the squirrels in Central Park
sq_map <- st_as_sf(no_dups_sd, coords = c('X', 'Y'))
ggplot(sq_map) + 
...
# =============================================================================
# STEP 3: OBSERVING WEATHER AND SNOWFALL DIFFERENCES
# =============================================================================
...
# Compare the yearly average of each location and there difference and summarize
...
# =============================================================================
# STEP 4: OBSERVING THE FUTURE OF SQUIRRELS AT VANDERBILT
# =============================================================================
...
# =============================================================================
# STEP 5: EXPORT DATA FRAMES TO .csv FILES FOR VISUALIZATION IN TABLEAU
# =============================================================================

write.csv(no_dups_sd, file = 'Squirrel_Data_No_Dups.csv')
write.csv(acre_df, file = 'Squirrel_Data_Acres.csv')
write.csv(trees_df, file = 'Squirrel_Data_Trees.csv')
write.csv(temp_df2, file = 'Squirrel_Data_Temps.csv')
write.csv(population_df, file = 'Squirrel_Data_Population.csv')